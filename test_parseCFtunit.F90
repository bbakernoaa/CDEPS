program test_parse
  ...
  string = "minutes since 2000-01-01 00:00:00"
  call shr_string_parseCFtunit(string, unit, bdate, bsec)
  print *, "unit = ", trim(unit), " bdate = ", bdate, " bsec = ", bsec

  string = "minute since 2000-01-01 00:00:00"
  call shr_string_parseCFtunit(string, unit, bdate, bsec)
  print *, "unit = ", trim(unit), " bdate = ", bdate, " bsec = ", bsec

  string = "years since 2000-01-01 00:00:00"
  call shr_string_parseCFtunit(string, unit, bdate, bsec)
  print *, "unit = ", trim(unit), " bdate = ", bdate, " bsec = ", bsec

  string = "months since 2000-01-01 00:00:00"
  call shr_string_parseCFtunit(string, unit, bdate, bsec)
  print *, "unit = ", trim(unit), " bdate = ", bdate, " bsec = ", bsec

  string = "weeks since 2000-01-01 00:00:00"
  call shr_string_parseCFtunit(string, unit, bdate, bsec)
  print *, "unit = ", trim(unit), " bdate = ", bdate, " bsec = ", bsec
