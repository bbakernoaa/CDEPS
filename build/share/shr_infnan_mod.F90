...
# 69 "/tide/share/shr_infnan_mod.F90.in"
...
# 75 "/tide/share/shr_infnan_mod.F90.in"
...
# 80 "/tide/share/shr_infnan_mod.F90.in"
...
# 85 "/tide/share/shr_infnan_mod.F90.in"
...
# 110 "/tide/share/shr_infnan_mod.F90.in"
...
# 120 "/tide/share/shr_infnan_mod.F90.in"
interface shr_infnan_to_r8
   module procedure nan_r8
   module procedure inf_r8
end interface

# 125 "/tide/share/shr_infnan_mod.F90.in"
...
# 165 "/tide/share/shr_infnan_mod.F90.in"
contains
...
! TYPE double,real
# 174 "/tide/share/shr_infnan_mod.F90.in"
...
# 180 "/tide/share/shr_infnan_mod.F90.in"
...
! TYPE double,real
# 191 "/tide/share/shr_infnan_mod.F90.in"
...
# 201 "/tide/share/shr_infnan_mod.F90.in"
...
! TYPE double,real
# 204 "/tide/share/shr_infnan_mod.F90.in"
...
# 214 "/tide/share/shr_infnan_mod.F90.in"
...
! TYPE double,real
# 222 "/tide/share/shr_infnan_mod.F90.in"
...
# 228 "/tide/share/shr_infnan_mod.F90.in"
...
! TYPE double,real
# 238 "/tide/share/shr_infnan_mod.F90.in"
elemental function shr_infnan_isposinf_double(x) result(isposinf)
  real(r8), intent(in) :: x
  logical :: isposinf
#if (102 == TYPEREAL)
...
# 249 "/tide/share/shr_infnan_mod.F90.in"
end function shr_infnan_isposinf_double
! TYPE double,real
# 238 "/tide/share/shr_infnan_mod.F90.in"
elemental function shr_infnan_isposinf_real(x) result(isposinf)
...
! TYPE double,real
# 252 "/tide/share/shr_infnan_mod.F90.in"
elemental function shr_infnan_isneginf_double(x) result(isneginf)
  real(r8), intent(in) :: x
  logical :: isneginf
#if (102 == TYPEREAL)
...
# 263 "/tide/share/shr_infnan_mod.F90.in"
end function shr_infnan_isneginf_double
! TYPE double,real
# 252 "/tide/share/shr_infnan_mod.F90.in"
elemental function shr_infnan_isneginf_real(x) result(isneginf)
...
! TYPE double,real
! DIMS 0,1,2,3,4,5,6,7
# 286 "/tide/share/shr_infnan_mod.F90.in"
...
# 324 "/tide/share/shr_infnan_mod.F90.in"
...
! TYPE double,real
! DIMS 0,1,2,3,4,5,6,7
# 328 "/tide/share/shr_infnan_mod.F90.in"
...
# 366 "/tide/share/shr_infnan_mod.F90.in"
...
# 374 "/tide/share/shr_infnan_mod.F90.in"
...
# 380 "/tide/share/shr_infnan_mod.F90.in"
end function nan_r8

# 382 "/tide/share/shr_infnan_mod.F90.in"
...
# 388 "/tide/share/shr_infnan_mod.F90.in"
end function nan_r4

# 390 "/tide/share/shr_infnan_mod.F90.in"
...
# 396 "/tide/share/shr_infnan_mod.F90.in"
end function inf_r8

# 398 "/tide/share/shr_infnan_mod.F90.in"
...
# 404 "/tide/share/shr_infnan_mod.F90.in"
end function inf_r4
